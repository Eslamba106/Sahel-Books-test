...
class StripeController extends Controller
{
	...
	public function index($slug = '')
	{
		...
		//$data['main_content'] = view('stripe_payment_form', $data, TRUE);
		return view('stripe_payment_form', $data);
	}
	...
	public function stripe_success($slug)
	{
		...
		$data['u_info'] = get_all_user_info_slug($slug);
		$data['main_content'] = view('payment/payment_success', $data)->render();
	...
	public function payment()
	{
		...
		return redirect('/my-stripe', 'refresh');
	}
	...
	public function payment__()
	{
		...
		if ($insert) :
			...
			return redirect(url('stripe-payment-success/' . $u_info['username']));
		endif;
	}
