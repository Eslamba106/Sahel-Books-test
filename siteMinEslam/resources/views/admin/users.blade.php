<div class="content-wrapper">
    ...
    <section class="content">
        <div class="list_area container">
            ...
            <form class="user_sort_form" role="search" autocomplete="off" action="<?php echo url('admin/users'); ?>" method="get">
                <div class="row">

                    <div class="col-md-6 col-xs-12 mt-5 pl-0">
                        <h3 class="box-title"><?php echo helper_trans('all-users'); ?> </h3>
                    </div>

                    <div class="col-md-3 col-xs-12 mt-5 pl-0">
                        <select class="form-control user_sort" name="package">
                            <option value=""><?php echo helper_trans('all-package'); ?></option>
                    ...
                    <div class="col-md-3 col-xs-12 mt-5 pl-0">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="<?php echo helper_trans('search-by-name-email'); ?> ..."
                                name="search" value="<?php if (isset($_GET['search'])) {
                                    echo $_GET['search'];
                                } ?>" autocomplete="off">
                            <button type="submit" class="input-group-addon btn btn-secondary"><i
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive mt-20 p-0">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php echo helper_trans('avatar'); ?></th>
                            <th><?php echo helper_trans('name'); ?></th>
                            <th><?php echo helper_trans('email'); ?></th>
                            <th><?php echo helper_trans('business'); ?></th>
                            <th><?php echo helper_trans('package'); ?></th>
                            <th><?php echo helper_trans('payment-status'); ?></th>
                            <th><?php echo helper_trans('join'); ?></th>
                            <th><?php echo helper_trans('expire'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr id="row_<?php echo html_escape($user->id); ?>">
                            ...
                            <td>
                                ...
                                <?php endif ?>
                                <img width="40px" class="img-circle" src="<?php echo url($avatar); ?>">
                            </td>
                            ...
                            <td>
                                ...
                                <p class="mt-10"><?php echo helper_trans('not-found'); ?></p>
                                <?php else : ?>
                            ...
                            <td>
                                ...
                                <?php if ($user->user_type == 'trial') : ?>
                                <span class="label label-warning"><?php echo date_dif(date('Y-m-d'), $user->trial_expire); ?> <?php echo helper_trans('days-left'); ?></span>
                                <?php else : ?>
                                <span class="label label-warning"><b><?php echo date_dif(date('Y-m-d'), $user->expire_on); ?> <?php echo helper_trans('days-left'); ?></span>
                                <?php endif ?>
                                <?php else : ?>
                            ...
                            <td class="actions">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default rounded btn-sm dropdown-toggle"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?php echo helper_trans('action'); ?>
                                    </button>
                                    <div class="dropdown-menu st" x-placement="bottom-start">

                                        <?php if ($user->status == 1) : ?>
                                        <li><a class="dropdown-item" href="<?php echo url('admin/users/status_action/2/' . $user->id); ?>"><i
                                                    class="fa fa-times"></i> <?php echo helper_trans('deactivate'); ?></a></li>
                                        <?php endif ?>
                                        <?php if ($user->status == 2 || $user->status == 0) : ?>
                                        <li><a class="dropdown-item" href="<?php echo url('admin/users/status_action/1/' . $user->id); ?>"><i
                                                    class="fa fa-check"></i> <?php echo helper_trans('activate'); ?></a></li>
                                        <?php endif ?>

                                        <li><a class="dropdown-item delete_item" data-val="User"
                                                data-id="<?php echo html_escape($user->id); ?>" href="<?php echo url('admin/users/delete/' . $user->id); ?>"
                                                class="on-defaults remove-row delete_item"><i class="fa fa-trash-o"></i>
                                                <?php echo helper_trans('delete'); ?></a></li>
                                    </div>
                                </div>
                            </td>
...
<div id="roleModal_<?php echo html_escape($user->id); ?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <form method="post" action="<?php echo url('admin/users/change_account/' . html_escape($user->id)); ?>" role="form">
            @csrf
