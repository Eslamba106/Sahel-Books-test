  ...
  <section class="content">
          ...
          <div class="card-body">
            <div class="d-flex flex-row">
              ...
              <div class="ml-20 align-self-center">
                ...
                <h4 class="text-muteds m-b-0"><?php echo helper_trans('invoices') ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex flex-row">
              ...
              <div class="ml-20 align-self-center">
                ...
                <h4 class="text-muteds m-b-0"><?php echo helper_trans('estimates') ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex flex-row">
              ...
              <div class="ml-20 align-self-center">
                ...
                <h4 class="text-muteds m-b-0"><?php echo helper_trans('users') ?></h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex flex-row">
              ...
              <div class="ml-20 align-self-center">
                ...
                <h4 class="text-muteds m-b-0"><?php echo helper_trans('business') ?></h4>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row mt-20">
      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo helper_trans('packages-by-users') ?></h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-3">
                <div class="row br1">
                  <?php foreach ($upackages as $package) : ?>
                    <div class="dash-package">
                      <h5 class="mb-0"><?php echo html_escape($package->name) ?> <?php echo helper_trans('package') ?> </h5>
                      <p class="mt-0"><strong><?php echo html_escape($package->total) ?></strong> <?php echo helper_trans('users') ?> </p>
                    </div>
                  <?php endforeach ?>
                </div>
              </div>
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo helper_trans('recently-joined-users') ?></h3>
          </div>
            ...
            <div class="media-list media-list-hover media-list-divided">
              ...
              <?php if (empty($users)) : ?>
                <div class="text-center">
                  <p class="p-20"><?php echo helper_trans('no-users-found') ?>!</p>
                </div>
              <?php else : ?>
                ...
                <div class="text-center bt-1 border-light p-2">
                  <a class="text-uppercase d-block font-size-12" href="<?php echo url('admin/users') ?>">See all Users <i class="fa fa-long-arrow-right"></i></a>
                </div>
      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo helper_trans('last-12-months-income') ?></h3>
          </div>
          <div class="box-body">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table class="table table-hover">
                <thead>
                  <tr>
                    <th><?php echo helper_trans('fiscal-year') ?> <i class="flaticon-information" data-toggle="tooltip" data-title="Fiscal year start is January 01"></i></th>
