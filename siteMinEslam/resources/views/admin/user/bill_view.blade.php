    ...
    <div class="content-wrappers">
        <section class="content p-0">
            ...
            <div class="readonly-title">
                <h2><?php echo helper_trans('bill'); ?> <?php echo html_escape($invoice->number); ?> <?php echo helper_trans('from'); ?> - <?php echo html_escape($invoice->business_name); ?></h2>
            </div>

            <div class="readonly-top-bar">
                <?php echo helper_trans('bill'); ?> <?php echo html_escape($invoice->number); ?> <i class="fa fa-circle"></i>
