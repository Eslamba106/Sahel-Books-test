                ...
                <div class="col-md-8 m-auto">
                    <div class="row mb-10">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="<?php echo $_SERVER['HTTP_REFERER']; ?>" class="btn btn-default m-auto"> <i class="flaticon-left-arrow" aria-hidden="true"></i><i class="fa fa-long-arrow-left"></i> <?php echo helper_trans('back') ?> </a>
                        </div>
                    </div>
                </div>
            </div>
