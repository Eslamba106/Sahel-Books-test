    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <div class="box add_area">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo helper_trans('subscription'); ?></h3>
                    </div>

                    <div class="box-body">
                        <p><?php echo helper_trans('your-subscription'); ?>: <strong><?php echo html_escape($user->package_name); ?> <?php echo helper_trans('plan'); ?></strong></p>
                        <p><?php echo helper_trans('price'); ?>: <strong><?php echo html_escape($user->amount); ?> <?php echo html_escape($settings->currency); ?></strong></p>
                        <p><?php echo helper_trans('billing-frequency'); ?> : <strong><?php echo ucfirst(html_escape($user->billing_type)); ?></strong> </p>
                        <p><?php echo helper_trans('last-billing'); ?> : <strong><?php echo my_date_show($user->created_at); ?></strong> </p>
                        <p><?php echo helper_trans('next-billing'); ?> : <strong><?php echo my_date_show($user->expire_on); ?></strong>
                            <strong class="text-danger">(<?php echo date_dif(date('Y-m-d'), $user->expire_on); ?> <?php echo helper_trans('days-left'); ?>)</strong></strong>
                        </p>
                    </div>
                    <div class="box-footer text-center soft-<?php if ($user->status == 'verified') {
                        ...
                        <?php echo helper_trans('payment-status'); ?>: &emsp; <i class="fa fa-<?php if ($user->status == 'verified') {
                            echo 'check';
                        } else {
                            echo 'times';
            ...
            <div class="col-md-8">
                <div class="box add_area">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo helper_trans('upgrade-plan'); ?> </h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive mt-20 p-0">
                            <div class="col-md-12 col-sm-12 col-xs-12 scroll">
                                ...
                                <div class="pricing-switcher mb-5 text-center">
                                    <p class="fieldset">
                                        <input type="radio" name="billing_type" value="monthly" class="switch_price"
                                            id="monthly-1" <?php if ($user->billing_type == 'monthly') {
                                                echo 'checked';
                                            } ?>>
                                        <label for="monthly-1"><?php echo helper_trans('monthly'); ?></label> &emsp;&emsp;
                                        <input type="radio" name="billing_type" value="yearly" class="switch_price"
                                            id="yearly-1" <?php if ($user->billing_type == 'yearly') {
                                                echo 'checked';
                                            } ?>>
                                        <label for="yearly-1"><?php echo helper_trans('yearly'); ?></label>
                      ...
                      foreach ($packages as $package) : ?>
                                            <td class="text-center">
                                                ...
                                                <h4>
                                                    ...
                                                    <span class="monthly_show soft-blue price_month"
                                                        style="display: <?php if ($user->billing_type == 'monthly') {
                                                            echo 'inline-block';
                                                        } else {
                                                            echo 'none';
                                                        } ?>;">
                                                        <?php echo html_escape($package->dis_month); ?>% <?php echo helper_trans('off'); ?>
                                                    </span>
                                                    <?php endif ?>

                                                    <?php if ($package->dis_year != 0 && $package->price != 0) : ?>
                                                    <span class="yearly_show soft-blue price_year"
                                                        style="display: <?php if ($user->billing_type == 'yearly') {
                                                            echo 'inline-block';
                                                        } else {
                                                            echo 'none';
                                                        } ?>;">
                                                        <?php echo html_escape($package->dis_year); ?>% <?php echo helper_trans('off'); ?>
                                                    </span>
                                                    <?php endif ?>
                                                </h4>
                                                <?php endif ?>
                                                ...
                                                <p class="mt-0 bill_type">
                                                    ...
                                                    <?php echo helper_trans('per-month'); ?>
                                                    <?php elseif ($user->billing_type == 'yearly') : ?>
                                                    <?php echo helper_trans('per-year'); ?>
                                                    <?php else : ?>
                                                    <?php echo helper_trans('per-year'); ?>
                                                    <?php endif ?>
                      ...
                      endforeach; ?>
                                        ...
                                        <tr class="monthly_row" style="display: <?php if ($user->billing_type == 'yearly') {
                                            echo 'none';
                                        } ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <p class="mb-0 feature-item"><i class="fa fa-check text-success"></i>
                                                </p>
                                        ...
                                        <tr class="yearly_row" style="display: <?php if ($user->billing_type == 'monthly') {
                                            echo 'none';
                                        } ?>">
                                            <td width="30%"><?php echo html_escape($feature->name); ?></td>
                                            <td class="text-center">
                      ...
                      foreach ($packages as $package) : ?>
                                            <td class="<?php if ($b == 2) {
                                                ...
                                                <a href="<?php echo url('admin/subscription/upgrade/' . $package->slug); ?>"
                                                    class="btn btn-<?php if ($b == 2) {
                                                        echo 'default';
                                                    } else {
                                                        echo 'default';
                                                    } ?> package_btn"><?php if ($b == 1) {
                                                        echo helper_trans('upgrade');
                                                    } else {
                                                        echo helper_trans('upgrade');
                                                    } ?></a>
                                            </td>
                                            <?php $b++;
                      endforeach; ?>
                                            <input type="hidden" name="billing_type" class="billing_type"
                                                value="<?php if ($user->billing_type == 'monthly') {
                                                    echo 'monthly';
                                                } else {
                                                    echo 'yearly';
                                                } ?>">
