...
if ($invoice->type == 3) {
    ...
    $email = helper_get_vendor($invoice->customer)->email;
} else {
    ...
    <section class="content">
        <div class="container">
            <div class="col-md-10 m-auto">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2 class="mt-0"><?php echo helper_trans('bill'); ?> #<?php echo html_escape($invoice->number); ?></h2>
                        <p><?php echo helper_trans('created'); ?>: <?php echo my_date_show($invoice->created_at); ?></p>
                    </div>

                    <div class="col-md-8 text-right">
                        <a href="<?php echo url('admin/bills/edit/' . md5($invoice->id)); ?>" class="btn btn-default btn-rounded mr-5"><i class="icon-pencil"></i>
                        ...
                        <div class="btn-group mr-5">
                            ...
                            <div class="dropdown-menu st" x-placement="bottom-start">
                                ...
                                <a class="dropdown-item mr-5" href="#recordPayment"
                                ...
                                <a class="dropdown-item delete_item"
                                    href="<?php echo url('admin/bills/delete/' . md5($invoice->id)); ?>"><?php echo helper_trans('delete'); ?></a>
                            </div>
                        </div>
                        <a href="<?php echo url('admin/bills/create'); ?>" class="btn btn-info btn-rounded"><i class="fa fa-plus"></i>
                            <?php echo helper_trans('create-new-bill'); ?></a>
                    </div>
...
<div id="recordPayment" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-zoom modal-md">
        <form id="record_payment_form" method="post" enctype="multipart/form-data" class="validate-form"
            action="<?php echo url('admin/bills/record_payment'); ?>" role="form" novalidate>
            @csrf
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vendor"><?php echo helper_trans('record-payment-bill'); ?></h4>
            ...
            <div class="modal-content modal-md">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="email_to" value="<?php echo $email; ?>"
                                required>
                        </div>
                    </div>
