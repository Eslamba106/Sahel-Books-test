            ...
            <tbody>
              ...
              foreach ($users as $user) : ?>
                <tr id="row_<?php echo html_escape($user->id); ?>">
                  ...
                  <td><a target="_blank" href="<?php echo url('profile/' . $user->slug) ?>"><span class="label label-default"><i class="icon-eye"></i> View profile</span></a></td>

                  <td>
                    <span class="label label-<?php if ($user->account_type == 'free') {
                                                echo "info";
                                              } else {
                                                echo "warning";
                                              } ?>">
                  ...
                  <td class="actions">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu custom-dw" role="menu">
                        ...
                        <?php if ($user->status == 1) : ?>
                          <li><a href="<?php echo url('admin/users/status_action/2/' . $user->id) ?>"><i class="fa fa-times"></i> Deactive</a></li>
                        <?php endif ?>
                        <?php if ($user->status == 2 || $user->status == 0) : ?>
                          <li><a href="<?php echo url('admin/users/status_action/1/' . $user->id) ?>"><i class="fa fa-check"></i> Active</a></li>
                        <?php endif ?>

                        <li><a href="#roleModal_<?php echo html_escape($user->id); ?>" data-toggle="modal"><i class="fa fa-circle"></i> Change Account</a></li>

                        <li><a href="<?php echo url('admin/users/edit/' . $user->id); ?>" class="on-defaults remove-row"><i class="fa fa-pencil"></i> Edit</a></li>

                        <li><a data-val="User" data-id="<?php echo html_escape($user->id); ?>" href="<?php echo url('admin/users/delete/' . $user->id); ?>" class="on-defaults remove-row delete_item"><i class="fa fa-trash-o"></i> Delete</a></li>
