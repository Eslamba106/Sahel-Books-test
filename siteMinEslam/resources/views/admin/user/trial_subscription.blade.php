    ...
    <div class="row">
      <div class="col-md-4">
        <div class="box add_area">
          ...
          <div class="box-body">
            <p><?php echo helper_trans('your-subscription') ?>: <strong><?php echo helper_trans('free-trial-of') ?> <?php echo settings()->trial_days . ' ' . helper_trans('days') ?></strong></p>
            <p><?php echo helper_trans('billing-frequency') ?> : <strong><?php echo settings()->trial_days . ' ' . helper_trans('days') ?></strong> </p>
            <p><?php echo helper_trans('created') ?> : <strong><?php echo my_date_show(user()->created_at) ?></strong>
              <strong class="text-danger">(<?php echo date_dif(date('Y-m-d'), user()->trial_expire) ?> <?php echo helper_trans('days-left') ?>)</strong></strong>
            </p>
          </div>
                    ...
                    <tr>
                      ...
                      foreach ($packages as $package) : ?>
                        <td class="text-center">
                          ...
                          <p class="mt-0 bill_type"><?php echo helper_trans('per-year') ?></p>
                        </td>
                      <?php $i++;
                      endforeach; ?>
                    </tr>
                    ...
                    <tr>
                      ...
                      foreach ($packages as $package) : ?>
                        <td class="<?php if ($b == 2) {
                          ...
                          <a href="<?php echo url('admin/subscription/upgrade/' . $package->slug) ?>" class="btn btn-<?php if ($b == 2) {
                                                                                                                        echo "info";
                                                                                                                      } else {
                                                                                                                        echo "default";
