    ...
    <section class="content">
        <div class="container">
            <div class="col-md-10 m-auto">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2 class="mt-0"><?php echo helper_trans('estimate'); ?> #<?php echo html_escape($invoice->number); ?></h2>
                        <p><?php echo helper_trans('created'); ?>: <?php echo my_date_show($invoice->created_at); ?></p>
                    </div>

                    <div class="col-md-8 text-right">
                        <a href="<?php echo url('admin/estimate/edit/' . md5($invoice->id)); ?>" class="btn btn-default btn-rounded mr-5"><i class="icon-pencil"></i>
                            <?php echo helper_trans('edit'); ?> </a>
                        <div class="btn-group mr-5">
                            <button type="button" class="btn btn-default btn-rounded dropdown-toggle"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="icon-settings"></i> <?php echo helper_trans('actions'); ?>
                            </button>
                            <div class="dropdown-menu st" x-placement="bottom-start">
                                ...
                                <a class="dropdown-item convert_to_invoice"
                                    href="<?php echo url('admin/estimate/convert/' . md5($invoice->id)); ?>"><?php echo helper_trans('convert-to-invoice'); ?></a>
                                <a target="_blank" class="dropdown-item"
                                    href="<?php echo url('readonly/export_pdf/' . md5($invoice->id)); ?>"><?php echo helper_trans('export-as-pdf'); ?></a>
                                <a class="dropdown-item" data-toggle="modal"
                                    href="#sendEstimateModal_<?php echo html_escape($invoice->id); ?>"><?php echo helper_trans('send'); ?></a>
                                <a target="_blank" class="dropdown-item"
                                    href="<?php echo url('readonly/estimate/preview/' . md5($invoice->id)); ?>"><?php echo helper_trans('preview-as-a-customer'); ?></a>
                                <a class="dropdown-item delete_item"
                                    href="<?php echo url('admin/estimate/delete/' . md5($invoice->id)); ?>"><?php echo helper_trans('delete'); ?></a>
                            </div>
                        </div>
                        <a href="<?php echo url('admin/estimate/create'); ?>" class="btn btn-info btn-rounded"><i class="fa fa-plus"></i>
                            <?php echo helper_trans('new-estimates'); ?></a>
                    </div>
...
<div id="sendEstimateModal_<?php echo html_escape($invoice->id); ?>" class="modal fade estimate_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-zoom modal-md">
        <form id="send-estimate-form" method="post" enctype="multipart/form-data"
            ...
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter"><?php echo helper_trans('send-estimate'); ?> <?php echo html_escape($invoice->id); ?></h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="email_to" value="<?php echo helper_get_customer($invoice->customer)->email; ?>"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-10">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" class="form-control" value="<?php echo user()->email; ?>"
                                name="email_myself">
                        </div>
                    </div>
