        ...
        <div class="text-center card-box" style="min-height: 377px;">
          <div class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="<?php echo url('admin/admin_users/edit/' . $user->id) ?>"><i class="fa fa-pencil"></i> Edit</a></li>
            </ul>
          </div>
          <div>
            ...
            <img src="<?php echo url($avatar) ?>" class="img-circle thumb-xl img-thumbnail m-b-10" alt="profile-image">
            ...
            <div class="pull-right">
              <a href="<?php echo url('admin/admin_users') ?>">
