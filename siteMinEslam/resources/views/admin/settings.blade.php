<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo url('admin/settings/update') ?>" role="form" class="form-horizontal">
      @csrf

      <div class="nav-tabs-custom">

        <ul class="nav nav-tabs admin">
          <li><a class="active" href="#content1" data-toggle="tab"><i class="fa fa-cog"></i> <span class="hidden-xs"><?php echo helper_trans('general-settings') ?></span></a></li>
          <li><a href="#content2" data-toggle="tab"><i class="fa fa-envelope"></i> <span class="hidden-xs"><?php echo helper_trans('email-settings') ?></span></a></li>
          <li><a href="#content3" data-toggle="tab"><i class="fa fa-refresh"></i> <span class="hidden-xs"><?php echo helper_trans('recaptcha-settings') ?></span> v2</a></li>
          <li><a href="#content5" data-toggle="tab"><i class="fa fa-cog"></i> <span class="hidden-xs"><?php echo helper_trans('social-settings') ?></span></a></li>
          <li><a href="#content6" data-toggle="tab"><i class="fa fa-file-text-o"></i> <span class="hidden-xs"><?php echo helper_trans('terms-of-service') ?></span></a></li>
        </ul>
        ...
        <div class="row mt-20">
          <div class="col-md-8">
            <div class="tab-content box">
              ...
              <div class="box-header">
                <h3 class="box-title"><?php echo helper_trans('update-settings') ?></h3>
              </div>
              ...
              <div class="active tab-pane" id="content1">
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <div class="col-sm-12">
                          <img width="200px" src="<?php echo url($settings->hero_img); ?>">
                          <div style="position:relative;" class="m-t-5">
                            <a class='btn btn-default' href='javascript:;'>
                              <i class="fa fa-cloud-upload"></i> <?php echo helper_trans('update') ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <div class="col-sm-12 pt-50">
                          <img width="100px" src="<?php echo url($settings->favicon); ?>">
                          <div style="position:relative;" class="m-t-5">
                            <a class='btn btn-default' href='javascript:;'>
                              <i class="fa fa-cloud-upload"></i> <?php echo helper_trans('upload-favicon') ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <div class="col-sm-12 pt-50">
                          <img width="200px" src="<?php echo url($settings->logo); ?>">
                          <div style="position:relative;" class="m-t-5">
                            <a class='btn btn-default' href='javascript:;'>
                              <i class="fa fa-cloud-upload"></i> <?php echo helper_trans('upload-logo') ?>
                  ...
                  <div class="form-group m-t-20">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('application-name') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group m-t-20">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('application-title') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('keywords') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('description') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('footer-about') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('admin-email') ?></label>
                    <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('copyright') ?></label>
                    <div class="col-sm-12">
              ...
              <div class="tab-pane" id="content2" aria-hidden="false">
                <div class="box-body">
                  <div class="callout callout-default">
                    <h4><i class="icon-info"></i> <?php echo helper_trans('gmail-smtp') ?></h4>

                    <p><?php echo helper_trans('gmail-host') ?>:&nbsp;&nbsp;smtp.gmail.com</br>
                      <?php echo helper_trans('gmail-port') ?>:&nbsp;&nbsp;465</p>

                    <p class="text-success mb-5"><strong><i class="fa fa-info-circle"></i> <?php echo helper_trans('mail-help-info') ?></strong></p>
                    <p><i class="fa fa-times-circle text-danger"></i> Two factor authentication off <br>
                      <i class="fa fa-check-circle text-success"></i> Less secure app on
                    </p>
                  </div>


                  <div class="form-group">
                    <label class="control-label"><?php echo helper_trans('mail-protocol') ?></label>
                  ...
                  <div class="form-group">
                    ...
                    <p class="small"><strong><i class="fa fa-info-circle"></i> <?php echo helper_trans('mail-help-info-2') ?></strong> </p>
                  </div>

                  <div class="form-group">
                    <label class="control-label"><?php echo helper_trans('mail-username') ?></label>
                    <input type="text" class="form-control" name="mail_username" value="<?php echo html_escape($settings->mail_username); ?>">
                  </div>

                  <div class="form-group">
                    <label class="control-label"><?php echo helper_trans('mail-password') ?></label>
                    <input type="password" class="form-control" name="mail_password" value="<?php echo base64_decode($settings->mail_password); ?>">
                  </div>

                  <div class="form-group mb-20">
                    <a target="_blank" href="<?php echo url('auth/test_mail') ?>" class="btn btn-default btn-lg mb-30 pull-left"><i class="fa fa-paper-plane"></i> <?php echo helper_trans('test-mail') ?></a>
                  </div>
              ...
              <div class="tab-pane" id="content3" aria-hidden="false">
                <div class="box-body">
                  <div class="form-group m-t-20">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('captcha-site-key') ?></label>
                    <div class="col-sm-12">
                      <input type="text" name="captcha_site_key" value="<?php echo html_escape($settings->captcha_site_key); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group m-t-20">
                    <label class="col-sm-2 control-label" for="example-input-normal"><?php echo helper_trans('captcha-secret-key') ?></label>
                    <div class="col-sm-12">
          ...
          <div class="col-md-4">
                  ...
                  <div class="col-sm-12">
                    <select class="form-control single_select" name="time_zone">
                      <?php foreach ($time_zones as $time_zone) : ?>
                        <option <?php if ($time_zone->id == $settings->time_zone) {
                                  echo "selected";
                                } ?> value="<?php echo $time_zone->id; ?>"><?php echo $time_zone->name; ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><?php echo helper_trans('set-trial-days') ?></h3>
              </div>

              <div class="box-body">
                <div class="form-group m-t-20">
                  <label class="col-sm-12 control-label" for="example-input-normal"><?php echo helper_trans('free-trial-of') ?></label>
                  <div class="col-sm-12">
                    <select class="form-control" name="trial_days">
                      <?php for ($t = 0; $t < 91; $t++) { ?>
                        <option <?php if ($settings->trial_days == $t) {
                                  echo "selected";
                                } ?> value="<?php echo $t; ?>"><?php echo $t; ?> days</option>
                      <?php } ?>
                    </select>
                    <p class="small"><i class="fa fa-info-circle"></i> <?php echo helper_trans('trial-disable') ?> </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <button type="submit" class="btn btn-info btn-block btn-md waves-effect w-md waves-light m-b-5"><i class="fa fa-check"></i> <?php echo helper_trans('save-changes') ?></button>
