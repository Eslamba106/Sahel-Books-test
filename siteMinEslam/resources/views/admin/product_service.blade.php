  ...
  <section class="content">
    ...
    <div class="box add_area" style="display: <?php if ($page_title == "Edit") {
      ...
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit") : ?>
            <a href="<?php echo url('admin/service') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> Back</a>
          <?php else : ?>
      ...
      <div class="box-body">
        <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo url('admin/services/add') ?>" role="form" novalidate>
          @csrf
          ...
          <div class="form-group">
            <?php if (isset($page_title) && $page_title == "Edit") : ?>
              <img src="<?php echo url($service[0]['thumb']) ?>"> <br><br>
            <?php endif ?>
    ...
    <?php if (isset($page_title) && $page_title != "Edit") : ?>
      ...
      <div class="box list_area">
        <div class="box-header with-border">
          <?php if (isset($page_title) && $page_title == "Edit") : ?>
            <h3 class="box-title">Edit service <a href="<?php echo url('admin/services') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> Back</a></h3>
          <?php else : ?>
              ...
              <tbody>
                ...
                foreach ($services as $service) : ?>
                  <tr id="row_<?php echo html_escape($service->id); ?>">
                    ...
                    <td><?php echo $i; ?></td>
                    <td><img width="100px" src="<?php echo url($service->thumb) ?>"></td>
                    <td><?php echo html_escape($service->name); ?></td>
                    <td><?php echo character_limiter($service->details, 80); ?></td>

                    <td class="actions" width="12%">
                      <a href="<?php echo url('admin/services/edit/' . html_escape($service->id)); ?>" class="on-default edit-row" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> &nbsp;

                      <a data-val="Category" data-id="<?php echo html_escape($service->id); ?>" href="<?php echo url('admin/services/delete/' . html_escape($service->id)); ?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a> &nbsp;
